...
- ### 필요성
  ...
  * 단순한 물리적 숨기가 아닌, 플레이어를 모방하는 AI NPC들 사이에서 플레이어 Seeker로부터 자신의 '행동'을 숨겨야 하는 고도화된 게임플레이 필요성.
  * Unity ML-Agents를 활용하여 실제 플레이어처럼 행동하는 AI NPC를 구현하고, 플레이어 간 비대칭 PvP 경험(Player Seeker vs Player Hider + AI NPCs) 제공.
